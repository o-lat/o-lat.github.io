...
function checkNum() {
    ...
    for (i = 0; i < valArr.length; i++) {
        ...
        else if (isNaN(valArr[i])==false) {
            // alert('I can see there is a number there. If you are asking me a math question, work it out yourself!');
			document.getElementById('output').innerHTML = 'I can see there is a number there. If you are asking me a math question, work it out yourself!';
        }
    }
}
...
function getResponseRude() {
	...
	ar[7] = "You should never say something like that.";
	ar[8] = "Please don't say rude to me.";
	ar[9] = "It makes me angry when you say that.";
	ar[10] = "Are you old enough to say that?";
	ar[11] = "Do you want to fight me?";
	ar[12] = "When you say those words I become unhappy";
